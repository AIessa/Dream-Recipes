...
To run the code, you can train a model yourself (this might take a few hours depending on your computer and the parameters). You will find instructions to do this in 'ingredients.py'. 
