...
def generate_recipe(category, effect, solid, liquid, main_ingredient):
	...
	rules_add = {
		...
		"origin": ["#[myThing:#concreteNoun#]title# \n\nWelcome to Dream Recipes. #[recDesc:#effect#][myRec:#recipeType#][liq1:#liquid#][liq2:#liquid#][crazyIngred:#crazyIngred#][solid1:#solid#][solid2:#solid#]intro# Happy cooking! \n\nYou will need:\n#squant# #mainIngr# \n#lquant.capitalize# of #liq1#\n#crazyIngred.capitalize# \n#solid1.capitalize#\n#lquant# of #liq2# \n#solid2.capitalize# for garnish \nA medium-sized cauldron \n\nMethods\n1. Take #squant# #mainIngr#, and shred into pieces using a couple of forks. \n2. Heat the cauldron over a flame, and add #lquant# of #liq1#. Add #squant# of #solid1#, and #lquant# of #solAdj# #crazyIngred# to the mix.\n3. Once the pot starts to boil, add the #mainIngr#. Fry for 5 mins until crisp.\n4. Stir the concoction until it reaches a #glowing#, #color#...now add #lquant# of #liq2#. We'll see it #glowing#, #color#...well, more of #color#ish #color#.\n5. Cook for 15 mins to soak the #mainIngr# in the broth. You might need to add an extra ladleful of #liq1# to ensure the #myRec# is #totally# potent. \n6. Finally, transfer to bowl and garnish with #solid2#.\n\n#concl# It won't be long until the #myRec# will work its magic."],
